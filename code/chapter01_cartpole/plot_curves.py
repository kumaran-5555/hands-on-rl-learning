"""
Extract training data from SwanLab backup files and generate comparison curves for all metrics
"""
...
def main():
    ...
    def get_iters_vals(name, metrics, key):
        """
        Unify the x-axis to Total Timesteps.
        SB3's step is already in timesteps (0, 2048, 4096, ...), use it directly.
        PyTorch PPO's step is the iteration index (0, 1, 2, ...), so multiply by 2048.
        """
    ...
    # ================================================
    # 1. Reward curve (large figure) — SB3 vs PyTorch comparison
    # ================================================
